...
# Figure 6A
pdf(file = "Figure 6A.pdf",width = 6,height = 8)
...
png(file = "Figure 6A.png",width = 6,height = 8,units = "in",res = 600)
pheatmap(tfatacsigpmat[finalatacsigtfs,],cluster_rows = F,cluster_cols = F,labels_row = gsub("\\(.*","",finalatacsigtfs),annotation_col = tissuemeta,annotation_colors = ann_cols,show_colnames = F,color = colorpanel(101,"white","firebrick"))
dev.off()
...
# Figure 6B
pdf(file = "Figure 6B.pdf",width = 6,height = 8)
pheatmap(tfmethsigpmat[finalmethsigtfs,],cluster_rows = F,cluster_cols = F,labels_row = gsub("\\(.*","",finalmethsigtfs),annotation_col = tissuemeta,annotation_colors = ann_cols,show_colnames = F,color = colorpanel(101,"white","firebrick"))
dev.off()

png(file = "Figure 6B.png",width = 6,height = 8,units = "in",res = 600)
pheatmap(tfmethsigpmat[finalmethsigtfs,],cluster_rows = F,cluster_cols = F,labels_row = gsub("\\(.*","",finalmethsigtfs),annotation_col = tissuemeta,annotation_colors = ann_cols,show_colnames = F,color = colorpanel(101,"white","firebrick"))
dev.off()
...
# Figure 6C - 592x580
pdf(file = "Figure 6C.pdf",width = 6,height = 8)
...
png(file = "Figure 6C.png",width = 6,height = 8, units = "in",res = 600)
pheatmap(tf50logpmat[finalsigtflist,],labels_row = gsub("\\(.*","",finalsigtflist),angle_col = 0,color = colorpanel(101,"white","firebrick"),breaks = seq(0,40,length.out = 101),cluster_cols = F,cluster_rows = F,annotation_col = tissuemeta,annotation_colors = ann_colsheatmaptrim,show_colnames = F)
dev.off()
...
pdf("Figure 6D.pdf",width = 7,height = 7)
...
png("Figure 6D.png",width = 7,height = 7,units = "in",res = 600)
pheatmap(-log10(motifCountByRegioncurrsigtrim[oursigset,rownames(motifCountByRegioncurrsigmetatrim[!motifCountByRegioncurrsigmetatrim$Region %in% "Overlaps.Gene",])]),labels_row = gsub("\\/.*","",gsub("\\(.*","",oursigset)),show_colnames = F,annotation_col = motifCountByRegioncurrsigmetatrim[,c("Region","Tissue")],breaks = seq(0,6,length.out = 101),color = colorpanel(101,"white","firebrick"),cluster_cols = F,annotation_colors = ann_cols)
dev.off()
...
pdf("Figure 6F.pdf",width = 7,height = 7)
...
png("Figure 6F.png",width = 7,height = 7,units = "in",res = 600)
...
pdf("Figure 6E.pdf",width = 7,height = 7)
pheatmap(-log10(motifCountByRegioncurrsigtrim[oursigset,rownames(motifCountByRegioncurrsigmetatrim)]),labels_row = gsub("\\/.*","",gsub("\\(.*","",oursigset)),show_colnames = F,annotation_col = motifCountByRegioncurrsigmetatrim[,c("Region","Tissue")],breaks = seq(0,6,length.out = 101),color = colorpanel(101,"white","firebrick"),cluster_cols = F,annotation_colors = ann_cols)
dev.off()

png("Figure 6E.png",width = 7,height = 7,units = "in",res = 600)
pheatmap(-log10(motifCountByRegioncurrsigtrim[oursigset,rownames(motifCountByRegioncurrsigmetatrim)]),labels_row = gsub("\\/.*","",gsub("\\(.*","",oursigset)),show_colnames = F,annotation_col = motifCountByRegioncurrsigmetatrim[,c("Region","Tissue")],breaks = seq(0,6,length.out = 101),color = colorpanel(101,"white","firebrick"),cluster_cols = F,annotation_colors = ann_cols)
dev.off()
...
pdf(file = "Supplemental Figure S18A.pdf",width = 6,height = 6)
...
png(file = "Supplemental Figure S18A.png",width = 6,height = 6,units = "in",res = 600)
pheatmap(t(scale(t(tfatacsigpctmat[finalatacsigtfs,]))),cluster_rows = F,cluster_cols = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),labels_row = gsub("\\(.*","",finalatacsigtfs),annotation_col = tissuemeta,annotation_colors = ann_cols,show_colnames = F)
dev.off()

pdf(file = "Supplemental Figure S18B.pdf",width = 6,height = 6)
...
png(file = "Supplemental Figure S18B.png",width = 6,height = 6,units = "in",res = 600)
pheatmap(t(scale(t(rnacontrolnorm[tfanno[finalatacsigtfs,"Ensembl"],controlcolumns[c(1:20,31:70)]]))),cluster_rows = F,cluster_cols = F,breaks = seq(-3,3,length.out = 101),color = colorpanel(101,"blue","white","red"),annotation_col = rnacontrolmeta[,c("Sex","Tissue")],annotation_colors = ann_cols,show_colnames = F,labels_row = enstosym[tfanno[finalatacsigtfs,"Ensembl"],"Symbol"],cellwidth = 4.0)
dev.off()
...
pdf(file = "Supplemental Figure S18C.pdf",width = 6.75,height = 6)
...
png(file = "Supplemental Figure S18C.png",width = 6.75,height = 6,units = "in",res = 600)
pheatmap(atacsigtfl2fcmat,cluster_rows = F,cluster_cols = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),labels_row = enstosym[rownames(atacsigtfl2fcmat),"Symbol"],annotation_col = atacsigtfl2fcmeta[,c("Group","Sex","Tissue")],annotation_colors = ann_cols,cellwidth = 6,show_colnames = F)
dev.off()
...
pdf(file = "Supplemental Figure S18D.pdf",width = 3.5,height = 5.5)
...
png(file = "Supplemental Figure S18D.png",width = 3.5,height = 5.5,units = "in",res = 600)
pheatmap(atactfexprenrichcor["Correlation",],cluster_rows = F,cluster_cols = F,display_numbers = T,number_color = "black",breaks = seq(-0.6,0.6,length.out = 101),color = colorpanel(101,"royalblue4","white","firebrick"),labels_row = colnames(atactfexprenrichcor),angle_col = 0,fontsize = 20,show_rownames = T,cellheight = 60)
dev.off()
...
pdf(file = "Supplemental Figure S18E.pdf",width = 6,height = 6)
...
png(file = "Supplemental Figure S18E.png",width = 6,height = 6,units = "in",res = 600)
ggplot(heartatacsigexprenrichcordf,aes(x=Enrichment.Z.Score,y=Expression.Z.Score,label=TF)) + geom_hline(yintercept = 0) + geom_vline(xintercept = 0) + geom_text_repel(max.overlaps = 15)+geom_smooth(method=lm,  linetype="dashed",color="darkred", fill="blue") + theme_classic() + ggtitle(paste("HEART Correlation: ",toString(cor(tfatacsigpctmatz[finalatacsigtfs,"HEART"],atactfcontrolmeanmatz[,"HEART"])),sep = "")) + theme(text = element_text(size = 15))
dev.off()

pdf(file = "Supplemental Figure S18F.pdf",width = 6,height = 6)
...
png(file = "Supplemental Figure S18F.png",width = 6,height = 6,units = "in",res = 600)
ggplot(lungatacsigexprenrichcordf,aes(x=Enrichment.Z.Score,y=Expression.Z.Score,label=TF)) + geom_hline(yintercept = 0) + geom_vline(xintercept = 0) + geom_text_repel(max.overlaps = 15)+geom_smooth(method=lm,  linetype="dashed",color="darkred", fill="blue") + theme_classic() + ggtitle(paste("LUNG Correlation: ",toString(cor(tfatacsigpctmatz[finalatacsigtfs,"LUNG"],atactfcontrolmeanmatz[,"LUNG"])),sep = "")) + theme(text = element_text(size = 15))
dev.off()
...
pdf(file = "Supplemental Figure S19A.pdf",width = 6,height = 8)
pheatmap(t(scale(t(tfmethsigpctmat[finalmethsigtfs,]))),cluster_rows = F,cluster_cols = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),labels_row = gsub("\\(.*","",finalmethsigtfs),annotation_col = tissuemeta,annotation_colors = ann_cols,show_colnames = F)
dev.off()

png(file = "Supplemental Figure S19A.png",width = 6,height = 8,units = "in",res = 600)
pheatmap(t(scale(t(tfmethsigpctmat[finalmethsigtfs,]))),cluster_rows = F,cluster_cols = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),labels_row = gsub("\\(.*","",finalmethsigtfs),annotation_col = tissuemeta,annotation_colors = ann_cols,show_colnames = F)
dev.off()

pdf(file = "Supplemental Figure S19B.pdf",width = 6,height = 8)
...
png(file = "Supplemental Figure S19B.png",width = 6,height = 8,units = "in",res = 600)
pheatmap(t(scale(t(rnacontrolnorm[tfanno[finalmethsigtfs,"Ensembl"],controlcolumns[c(1:20,31:70)]]))),cluster_rows = F,cluster_cols = F,breaks = seq(-3,3,length.out = 101),color = colorpanel(101,"blue","white","red"),annotation_col = rnacontrolmeta[,c("Sex","Tissue")],annotation_colors = ann_cols,show_colnames = F,labels_row = enstosym[tfanno[finalmethsigtfs,"Ensembl"],"Symbol"],cellwidth = 4.0)
dev.off()
...
pdf(file = "Supplemental Figure S19C.pdf",width = 6.75,height = 8)
pheatmap(methsigtfl2fcmat,cluster_rows = F,cluster_cols = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),labels_row = enstosym[rownames(methsigtfl2fcmat),"Symbol"],annotation_col = methsigtfl2fcmeta[,c("Group","Sex","Tissue")],annotation_colors = ann_cols,cellwidth = 6,show_colnames = F)
dev.off()
png(file = "Supplemental Figure S19C.png",width = 6.75,height = 8,units = "in",res = 600)
pheatmap(methsigtfl2fcmat,cluster_rows = F,cluster_cols = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),labels_row = enstosym[rownames(methsigtfl2fcmat),"Symbol"],annotation_col = methsigtfl2fcmeta[,c("Group","Sex","Tissue")],annotation_colors = ann_cols,cellwidth = 6,show_colnames = F)
dev.off()
...
pdf(file = "Supplemental Figure S19D.pdf",width = 3.5,height = 5.5)
pheatmap(methtfexprenrichcor["Correlation",],cluster_rows = F,cluster_cols = F,display_numbers = T,number_color = "black",breaks = seq(-0.6,0.6,length.out = 101),color = colorpanel(101,"royalblue4","white","firebrick"),labels_row = colnames(methtfexprenrichcor),angle_col = 0,fontsize = 20,show_rownames = T,cellheight = 60)
dev.off()

png(file = "Supplemental Figure S19D.png",width = 3.5,height = 5.5,units = "in",res = 600)
pheatmap(methtfexprenrichcor["Correlation",],cluster_rows = F,cluster_cols = F,display_numbers = T,number_color = "black",breaks = seq(-0.6,0.6,length.out = 101),color = colorpanel(101,"royalblue4","white","firebrick"),labels_row = colnames(methtfexprenrichcor),angle_col = 0,fontsize = 20,show_rownames = T,cellheight = 43)
dev.off()
...
pdf(file = "Supplemental Figure S19E.pdf",width = 6,height = 6)
...
png(file = "Supplemental Figure S19E.png",width = 6,height = 6,units = "in",res = 600)
ggplot(hippomethsigexprenrichcordf,aes(x=Enrichment.Z.Score,y=Expression.Z.Score,label=TF)) + geom_hline(yintercept = 0) + geom_vline(xintercept = 0) + geom_text_repel(max.overlaps = 15)+geom_smooth(method=lm,  linetype="dashed",color="darkred", fill="blue") + theme_classic() + ggtitle(paste("HIPPOC Correlation: ",toString(cor(tfmethsigpctmatz[finalmethsigtfs,"HIPPOC"],methtfcontrolmeanmatz[,"HIPPOC"])),sep = "")) + theme(text = element_text(size = 15))
dev.off()

pdf(file = "Supplemental Figure S19F.pdf",width = 6,height = 6)
...
png(file = "Supplemental Figure S19F.png",width = 6,height = 6,units = "in",res = 600)
ggplot(brownmethsigexprenrichcordf,aes(x=Enrichment.Z.Score,y=Expression.Z.Score,label=TF)) + geom_hline(yintercept = 0) + geom_vline(xintercept = 0) + geom_text_repel(max.overlaps = 15)+geom_smooth(method=lm,  linetype="dashed",color="darkred", fill="blue") + theme_classic() + ggtitle(paste("BAT Correlation: ",toString(cor(tfmethsigpctmatz[finalmethsigtfs,"BAT"],methtfcontrolmeanmatz[,"BAT"])),sep = "")) + theme(text = element_text(size = 15))
dev.off()
...
pdf(file = "Supplemental Figure S20A.pdf",width = 6,height = 6)
...
png(file = "Supplemental Figure S20A.png",width = 6,height = 6,units = "in",res = 600)
pheatmap(t(scale(t(tf50pctmat[finalsigtflist,]))),labels_row = gsub("\\(.*","",finalsigtflist),angle_col = 0,color = colorpanel(101,"blue","white","red"),breaks = seq(-2,2,length.out = 101),cluster_cols = F,cluster_rows = F,annotation_col = tissuemeta,annotation_colors = ann_colsheatmaptrim,show_colnames = F)
dev.off()
...
pdf(file = "Supplemental Figure S20B.pdf",width = 6,height = 6)
...
png(file = "Supplemental Figure S20B.png",width = 6,height = 6,units = "in",res = 600)
pheatmap(t(scale(t(rnacontrolnorm[sigtfensembl,controlcolumns]))),cluster_rows = F,cluster_cols = F,labels_row = tfanno[finalsigtflist,"Gene.Name"],show_colnames = F,annotation_col = rnacontrolmetacolumns[,c("Sex","Tissue")],breaks = seq(-3,3,length.out = 101),color = colorpanel(101,"blue","white","red"),annotation_colors = ann_cols,cellwidth = 3.5)
dev.off()
...
pdf(file = "Supplemental Figure S20C.pdf",width = 7,height = 6)
...
png(file = "Supplemental Figure S20C.png",width = 7,height = 6,units = "in",res = 600)
pheatmap(rnasigtfl2fcmat,cluster_rows = F,angle_col = 315,labels_row = tfanno[finalsigtflist,"Gene.Name"],breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),cluster_cols = F,annotation_col = columnmetadf[,c("Group","Sex","Tissue")],show_colnames = F,annotation_colors = ann_cols,cellwidth = 5)
dev.off()
...
# Supplemental Figure S20D
pdf(file = "Supplemental Figure S20D.pdf",width = 3.5,height = 5.5)
...
png(file = "Supplemental Figure S20D.png",width = 3.5,height = 5.5,units = "in",res = 600)
pheatmap(tfexprenrichcor["Correlation",],cluster_rows = F,cluster_cols = F,display_numbers = T,number_color = "black",breaks = seq(0,0.6,length.out = 101),color = colorpanel(101,"white","firebrick"),labels_row = colnames(tfexprenrichcor),angle_col = 0,fontsize = 20,show_rownames = T,cellheight = 43)
dev.off()
...
pdf(file = "Supplemental Figure S20E.pdf",width = 6,height = 6)
...
png(file = "Supplemental Figure S20E.png",width = 6,height = 6,units = "in",res = 600)
ggplot(liverexprenrichcordf,aes(x=Enrichment.Z.Score,y=Expression.Z.Score,label=TF)) + geom_hline(yintercept = 0) + geom_vline(xintercept = 0) + geom_text_repel(max.overlaps = 15)+geom_smooth(method=lm,  linetype="dashed",color="darkred", fill="blue") + theme_classic() + ggtitle(paste("LIVER Correlation: ",toString(cor(tf50pctmatz[finalsigtflist,"LIVER"],ourcontrolmeanmatz[,"LIVER"])),sep = "")) + theme(text = element_text(size = 15))
dev.off()

# Supplemental Figure S20F
pdf(file = "Supplemental Figure S20F.pdf",width = 6,height = 6)
...
png(file = "Supplemental Figure S20F.png",width = 6,height = 6,units = "in",res = 600)
ggplot(lungexprenrichcordf,aes(x=Enrichment.Z.Score,y=Expression.Z.Score,label=TF)) + geom_hline(yintercept = 0) + geom_vline(xintercept = 0) + geom_text_repel(max.overlaps = 15)+geom_smooth(method=lm,  linetype="dashed",color="darkred", fill="blue") + theme_classic() + ggtitle(paste("LUNG Correlation: ",toString(cor(tf50pctmatz[finalsigtflist,"LUNG"],ourcontrolmeanmatz[,"LUNG"])),sep = "")) + theme(text = element_text(size = 15))
dev.off()


#####
# Supplemental Figure S21_S22_S23
####
...
pdf(file = "Supplemental Figure S21A.pdf",width = 6.5,height = 5.5)
...
pdf(file = "Supplemental Figure S22A.pdf",width = 6.5,height = 5.5)
...
pdf(file = "Supplemental Figure S23A.pdf",width = 6.5,height = 5.5)
...
png(file = "Supplemental Figure S21A.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DAR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DAR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S22A.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S23A.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DAR.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DAR.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()
...
ourdf <- data.frame(row.names = atacsigtflist,
                    ...
                    "DMR Enrichment" = tfmethsigpmat[atacsigtflist,ourtissue],
                    "TF" = gsub("\\(.*","",atacsigtflist))
pdf(file = "Supplemental Figure S21B.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DAR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DAR.Enrichment)),sep = ""))
dev.off()

pdf(file = "Supplemental Figure S22B.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

pdf(file = "Supplemental Figure S23B.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DAR.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DAR.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S21B.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DAR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DAR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S22B.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S23B.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DAR.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DAR.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()
...
ourdf <- data.frame(row.names = atacsigtflist,
                    ...
                    "DMR Enrichment" = tfmethsigpmat[atacsigtflist,ourtissue],
                    "TF" = gsub("\\(.*","",atacsigtflist))
pdf(file = "Supplemental Figure S22C.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S22C.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()
...
ourdf <- data.frame(row.names = atacsigtflist,
                    ...
                    "DMR Enrichment" = tfmethsigpmat[atacsigtflist,ourtissue],
                    "TF" = gsub("\\(.*","",atacsigtflist))
pdf(file = "Supplemental Figure S21C.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DAR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DAR.Enrichment)),sep = ""))
dev.off()

pdf(file = "Supplemental Figure S22D.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

pdf(file = "Supplemental Figure S23C.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DAR.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DAR.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S21C.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DAR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DAR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S22D.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S23C.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DAR.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DAR.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()
...
ourdf <- data.frame(row.names = atacsigtflist,
                    ...
                    "DMR Enrichment" = tfmethsigpmat[atacsigtflist,ourtissue],
                    "TF" = gsub("\\(.*","",atacsigtflist))
pdf(file = "Supplemental Figure S21D.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DAR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DAR.Enrichment)),sep = ""))
dev.off()

pdf(file = "Supplemental Figure S22E.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

pdf(file = "Supplemental Figure S23D.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DAR.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DAR.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S21D.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DAR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DAR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S22E.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S23D.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DAR.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DAR.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()
...
ourdf <- data.frame(row.names = atacsigtflist,
                    ...
                    "DMR Enrichment" = tfmethsigpmat[atacsigtflist,ourtissue],
                    "TF" = gsub("\\(.*","",atacsigtflist))
pdf(file = "Supplemental Figure S21E.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DAR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DAR.Enrichment)),sep = ""))
dev.off()

pdf(file = "Supplemental Figure S22F.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

pdf(file = "Supplemental Figure S23E.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DAR.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DAR.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S21E.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DAR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DAR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S22F.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S23E.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DAR.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DAR.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()
...
ourdf <- data.frame(row.names = atacsigtflist,
                    ...
                    "DMR Enrichment" = tfmethsigpmat[atacsigtflist,ourtissue],
                    "TF" = gsub("\\(.*","",atacsigtflist))
pdf(file = "Supplemental Figure S21F.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DAR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DAR.Enrichment)),sep = ""))
dev.off()

pdf(file = "Supplemental Figure S22G.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

pdf(file = "Supplemental Figure S23F.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DAR.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DAR.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S21F.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DAR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DAR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S22G.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S23F.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DAR.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DAR.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()
...
ourdf <- data.frame(row.names = atacsigtflist,
                    ...
                    "DMR Enrichment" = tfmethsigpmat[atacsigtflist,ourtissue],
                    "TF" = gsub("\\(.*","",atacsigtflist))
pdf(file = "Supplemental Figure S22H.pdf",width = 6.5,height = 5.5)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

png(file = "Supplemental Figure S22H.png",width = 6.5,height = 5.5,units = "in",res = 600)
ggplot(ourdf,aes(x=DEGaP.Enrichment,y=DMR.Enrichment,labels=TF))+geom_point()+geom_text_repel(label = ourdf$TF) + theme_classic() + ggtitle(paste(ourtissue," Correlation: ",toString(cor(ourdf$DEGaP.Enrichment,ourdf$DMR.Enrichment)),sep = ""))
dev.off()

gc()

save.image("Figure6_S18_S19_S20_S21_S22_S23.RData")
...
# Supplemental Figure S24A
pdf(file = "Supplemental Figure S24A.pdf",width = 7,height = 5.5)
...
dev.off()
# Supplemental Figure S24B
pdf(file = "Supplemental Figure S24B.pdf",width = 7,height = 5.5)
...
dev.off()
# Supplemental Figure S24C
pdf(file = "Supplemental Figure S24C.pdf",width = 7,height = 5.5)
...
dev.off()
# Supplemental Figure S24D
pdf(file = "Supplemental Figure S24D.pdf",width = 7,height = 5.5)
...
dev.off()
# Supplemental Figure S24E
pdf(file = "Supplemental Figure S24E.pdf",width = 7,height = 5.5)
...
dev.off()
# Supplemental Figure S24F
pdf(file = "Supplemental Figure S24F.pdf",width = 7,height = 5.5)
...
dev.off()
# Supplemental Figure S24G
pdf(file = "Supplemental Figure S24G.pdf",width = 7,height = 5.5)
...
dev.off()
# Supplemental Figure S24H
pdf(file = "Supplemental Figure S24H.pdf",width = 7,height = 5.5)
...
png(file = "Supplemental Figure S24A.png",width = 7,height = 5.5,units = "in",res = 600)
pheatmap(t(scale(t(gastro50motifdf[apply(gastro50motifdf,1,max) > 0.01,order(motifdfmetadata$Region,motifdfmetadata$Training.Response)]))),labels_row = gsub("\\(.*","",rownames(gastro50motifdf))[apply(gastro50motifdf,1,max) > 0.01],annotation_col = motifdfmetadata[,c("Week","Training.Response","Region")],annotation_colors = ann_colsheatmaptrim,show_colnames = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),show_rownames = F,cluster_cols = F)
dev.off()
# Supplemental Figure S24B
png(file = "Supplemental Figure S24B.png",width = 7,height = 5.5,units = "in",res = 600)
pheatmap(t(scale(t(heart50motifdf[apply(heart50motifdf,1,max) > 0.01,order(motifdfmetadata$Region,motifdfmetadata$Training.Response)]))),labels_row = gsub("\\(.*","",rownames(heart50motifdf))[apply(heart50motifdf,1,max) > 0.01],annotation_col = motifdfmetadata[,c("Week","Training.Response","Region")],annotation_colors = ann_colsheatmaptrim,show_colnames = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),show_rownames = F,cluster_cols = F)
dev.off()
# Supplemental Figure S24C
png(file = "Supplemental Figure S24C.png",width = 7,height = 5.5,units = "in",res = 600)
pheatmap(t(scale(t(hippo50motifdf[apply(hippo50motifdf,1,max) > 0.01,order(motifdfmetadata$Region,motifdfmetadata$Training.Response)]))),labels_row = gsub("\\(.*","",rownames(hippo50motifdf))[apply(hippo50motifdf,1,max) > 0.01],annotation_col = motifdfmetadata[,c("Week","Training.Response","Region")],annotation_colors = ann_colsheatmaptrim,show_colnames = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),show_rownames = F,cluster_cols = F)
dev.off()
# Supplemental Figure S24D
png(file = "Supplemental Figure S24D.png",width = 7,height = 5.5,units = "in",res = 600)
pheatmap(t(scale(t(kidney50motifdf[apply(kidney50motifdf,1,max) > 0.01,order(motifdfmetadata$Region,motifdfmetadata$Training.Response)]))),labels_row = gsub("\\(.*","",rownames(kidney50motifdf))[apply(kidney50motifdf,1,max) > 0.01],annotation_col = motifdfmetadata[,c("Week","Training.Response","Region")],annotation_colors = ann_colsheatmaptrim,show_colnames = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),show_rownames = F,cluster_cols = F)
dev.off()
# Supplemental Figure S24E
png(file = "Supplemental Figure S24E.png",width = 7,height = 5.5,units = "in",res = 600)
pheatmap(t(scale(t(liver50motifdf[apply(liver50motifdf,1,max) > 0.01,order(motifdfmetadata$Region,motifdfmetadata$Training.Response)]))),labels_row = gsub("\\(.*","",rownames(liver50motifdf))[apply(liver50motifdf,1,max) > 0.01],annotation_col = motifdfmetadata[,c("Week","Training.Response","Region")],annotation_colors = ann_colsheatmaptrim,show_colnames = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),show_rownames = F,cluster_cols = F)
dev.off()
# Supplemental Figure S24F
png(file = "Supplemental Figure S24F.png",width = 7,height = 5.5,units = "in",res = 600)
pheatmap(t(scale(t(lung50motifdf[apply(lung50motifdf,1,max) > 0.01,order(motifdfmetadata$Region,motifdfmetadata$Training.Response)]))),labels_row = gsub("\\(.*","",rownames(lung50motifdf))[apply(lung50motifdf,1,max) > 0.01],annotation_col = motifdfmetadata[,c("Week","Training.Response","Region")],annotation_colors = ann_colsheatmaptrim,show_colnames = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),show_rownames = F,cluster_cols = F)
dev.off()
# Supplemental Figure S24G
png(file = "Supplemental Figure S24G.png",width = 7,height = 5.5,units = "in",res = 600)
pheatmap(t(scale(t(brown50motifdf[apply(brown50motifdf,1,max) > 0.01,order(motifdfmetadata$Region,motifdfmetadata$Training.Response)]))),labels_row = gsub("\\(.*","",rownames(brown50motifdf))[apply(brown50motifdf,1,max) > 0.01],annotation_col = motifdfmetadata[,c("Week","Training.Response","Region")],annotation_colors = ann_colsheatmaptrim,show_colnames = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),show_rownames = F,cluster_cols = F)
dev.off()
# Supplemental Figure S24H
png(file = "Supplemental Figure S24H.png",width = 7,height = 5.5,units = "in",res = 600)
pheatmap(t(scale(t(white50motifdf[apply(white50motifdf,1,max) > 0.01,order(motifdfmetadata$Region,motifdfmetadata$Training.Response)]))),labels_row = gsub("\\(.*","",rownames(white50motifdf))[apply(white50motifdf,1,max) > 0.01],annotation_col = motifdfmetadata[,c("Week","Training.Response","Region")],annotation_colors = ann_colsheatmaptrim,show_colnames = F,breaks = seq(-2,2,length.out = 101),color = colorpanel(101,"blue","white","red"),show_rownames = F,cluster_cols = F)
dev.off()
...
# Fig S25A - 750x1500
pdf(file = "Supplemental Figure S25A.pdf",width = 7.5,height = 15)
pheatmap(t(scale(t(gastro50motifdf[c(gastromotif50promupregspec,gastromotif50promdownregspec),
         ...
         fontsize = 15)
dev.off()
png(file = "Supplemental Figure S25A.png",width = 7.5,height = 15,units = "in",res = 600)
pheatmap(t(scale(t(gastro50motifdf[c(gastromotif50promupregspec,gastromotif50promdownregspec),
                                   c("Enrichment.in.W1.UpReg.Sig.Prom.Peaks",
                                     "Enrichment.in.W2.UpReg.Sig.Prom.Peaks",
                                     "Enrichment.in.W4.UpReg.Sig.Prom.Peaks",
...
# Fig S25B - 750x1500
pdf(file = "Supplemental Figure S25B.pdf",width = 7.5,height = 15)
pheatmap(t(scale(t(heart50motifdf[c(heartmotif50promupregspec,heartmotif50promdownregspec),
         ...
         fontsize = 15)
dev.off()
png(file = "Supplemental Figure S25B.png",width = 7.5,height = 15,units = "in",res = 600)
pheatmap(t(scale(t(heart50motifdf[c(heartmotif50promupregspec,heartmotif50promdownregspec),
                                  c("Enrichment.in.W1.UpReg.Sig.Prom.Peaks",
                                    "Enrichment.in.W2.UpReg.Sig.Prom.Peaks",
                                    "Enrichment.in.W4.UpReg.Sig.Prom.Peaks",
...
# Fig S25C - 750x1500
pdf(file = "Supplemental Figure S25C.pdf",width = 7.5,height = 15)
pheatmap(t(scale(t(hippo50motifdf[c(hippomotif50promupregspec,hippomotif50promdownregspec),
         ...
         fontsize = 15)
dev.off()
png(file = "Supplemental Figure S25C.png",width = 7.5,height = 15,units = "in",res = 600)
pheatmap(t(scale(t(hippo50motifdf[c(hippomotif50promupregspec,hippomotif50promdownregspec),
                                  c("Enrichment.in.W1.UpReg.Sig.Prom.Peaks",
                                    "Enrichment.in.W2.UpReg.Sig.Prom.Peaks",
                                    "Enrichment.in.W4.UpReg.Sig.Prom.Peaks",
...
# Fig S25D - 750x1500
pdf(file = "Supplemental Figure S25D.pdf",width = 7.5,height = 15)
pheatmap(t(scale(t(kidney50motifdf[c(kidneymotif50promupregspec,kidneymotif50promdownregspec),
         ...
         fontsize = 15)
dev.off()
png(file = "Supplemental Figure S25D.png",width = 7.5,height = 15,units = "in",res = 600)
pheatmap(t(scale(t(kidney50motifdf[c(kidneymotif50promupregspec,kidneymotif50promdownregspec),
                                   c("Enrichment.in.W1.UpReg.Sig.Prom.Peaks",
                                     "Enrichment.in.W2.UpReg.Sig.Prom.Peaks",
                                     "Enrichment.in.W4.UpReg.Sig.Prom.Peaks",
...
# Fig S25E - 750x1500
pdf(file = "Supplemental Figure S25E.pdf",width = 7.5,height = 15)
pheatmap(t(scale(t(liver50motifdf[c(livermotif50promupregspec,livermotif50promdownregspec),
         ...
         fontsize = 15)
dev.off()
png(file = "Supplemental Figure S25E.png",width = 7.5,height = 15,units = "in",res = 600)
pheatmap(t(scale(t(liver50motifdf[c(livermotif50promupregspec,livermotif50promdownregspec),
                                  c("Enrichment.in.W1.UpReg.Sig.Prom.Peaks",
                                    "Enrichment.in.W2.UpReg.Sig.Prom.Peaks",
                                    "Enrichment.in.W4.UpReg.Sig.Prom.Peaks",
...
# Fig S25F - 750x1500
pdf(file = "Supplemental Figure S25F.pdf",width = 7.5,height = 15)
pheatmap(t(scale(t(lung50motifdf[c(lungmotif50promupregspec,lungmotif50promdownregspec),
         ...
         fontsize = 15)
dev.off()
png(file = "Supplemental Figure S25F.png",width = 7.5,height = 15,units = "in",res = 600)
pheatmap(t(scale(t(lung50motifdf[c(lungmotif50promupregspec,lungmotif50promdownregspec),
                                 c("Enrichment.in.W1.UpReg.Sig.Prom.Peaks",
                                   "Enrichment.in.W2.UpReg.Sig.Prom.Peaks",
                                   "Enrichment.in.W4.UpReg.Sig.Prom.Peaks",
...
# Fig S25G - 750x1500
pdf(file = "Supplemental Figure S25G.pdf",width = 7.5,height = 15)
pheatmap(t(scale(t(brown50motifdf[c(brownmotif50promupregspec,brownmotif50promdownregspec),
         ...
         fontsize = 15)
dev.off()
png(file = "Supplemental Figure S25G.png",width = 7.5,height = 15,units = "in",res = 600)
pheatmap(t(scale(t(brown50motifdf[c(brownmotif50promupregspec,brownmotif50promdownregspec),
                                  c("Enrichment.in.W1.UpReg.Sig.Prom.Peaks",
                                    "Enrichment.in.W2.UpReg.Sig.Prom.Peaks",
                                    "Enrichment.in.W4.UpReg.Sig.Prom.Peaks",
...
# Fig S25H - 750x1500
pdf(file = "Supplemental Figure S25H.pdf",width = 7.5,height = 15)
pheatmap(t(scale(t(white50motifdf[c(whitemotif50promupregspec,whitemotif50promdownregspec),
         ...
         fontsize = 15)
dev.off()
png(file = "Supplemental Figure S25H.png",width = 7.5,height = 15,units = "in",res = 600)
pheatmap(t(scale(t(white50motifdf[c(whitemotif50promupregspec,whitemotif50promdownregspec),
                                  c("Enrichment.in.W1.UpReg.Sig.Prom.Peaks",
                                    "Enrichment.in.W2.UpReg.Sig.Prom.Peaks",
                                    "Enrichment.in.W4.UpReg.Sig.Prom.Peaks",
...
# Figure 7A
pdf(file = "Figure 7A.pdf",width = 5,height = 6)
...
# Figure 7B
pdf(file = "Figure 7B.pdf",width = 5,height = 6)
...
# Figure 7A
png(file = "Figure 7A.png",width = 5,height = 6,units = "in",res = 600)
pheatmap(tfmotif50prommeanzmatupreg[apply(abs(tfmotif50prommeanzmatupreg[,c(3,7,5,8,2,6,1,4)]),1,max) > 0.88,c(3,7,5,8,2,6,1,4)],show_rownames = T,cluster_cols = F,breaks = seq(-1,1,length.out = 101),color = colorpanel(101,"blue","white","red"),angle_col = 0,labels_row = gsub("\\(.*","",rownames(tfmotif50prommeanzmatupreg[apply(abs(tfmotif50prommeanzmatupreg[,c(3,7,5,8,2,6,1,4)]),1,max) > 0.88,])),annotation_col = promzmatmetadf,annotation_colors = tissue_cols,show_colnames = F,cellwidth = 18)
dev.off()

# Figure 7B
png(file = "Figure 7B.png",width = 5,height = 6,units = "in",res = 600)
pheatmap(tfmotif50prommeanzmatdownreg[apply(abs(tfmotif50prommeanzmatdownreg[,c(11,15,10,16,9,12,13,14)]),1,max) > 0.88,c(11,15,10,16,9,12,13,14)],show_rownames = T,cluster_cols = F,breaks = seq(-1,1,length.out = 101),color = colorpanel(101,"blue","white","red"),angle_col = 0,labels_row = gsub("\\(.*","",rownames(tfmotif50prommeanzmatdownreg[apply(abs(tfmotif50prommeanzmatdownreg[,c(11,15,10,16,9,12,13,14)]),1,max) > 0.88,])),annotation_col = promzmatmetadf,annotation_colors = tissue_cols,show_colnames = F,cellwidth = 18)
dev.off()
...
# Figure 7C
pdf(file = "Figure 7C.pdf",width = 5,height = 4)
...
png(file = "Figure 7C.png",width = 5,height = 4,units = "in",res = 600)
pheatmap(prommeanupregtissuecomp50,display_numbers = T,angle_col = 0,color = colorpanel(101,"white","firebrick"),annotation_row = tissuemeta,annotation_col = tissuemeta,annotation_colors = ann_cols,show_rownames = F,show_colnames = F,fontsize = 15,number_color = "black",number_format = "%d",breaks = seq(0,30,length.out = 101),annotation_names_col = F,annotation_names_row = F,annotation_legend = F)
dev.off()

# Figure 7D
pdf(file = "Figure 7D.pdf",width = 5,height = 4)
pheatmap(prommeandownregtissuecomp50,display_numbers = T,angle_col = 0,color = colorpanel(101,"white","firebrick"),annotation_row = tissuemeta,annotation_col = tissuemeta,annotation_colors = ann_cols,show_rownames = F,show_colnames = F,fontsize = 15,number_color = "black",number_format = "%d",breaks = seq(0,30,length.out = 101),annotation_names_col = F,annotation_names_row = F,annotation_legend = F)
dev.off()

png(file = "Figure 7D.png",width = 5,height = 4,units = "in",res = 600)
pheatmap(prommeandownregtissuecomp50,display_numbers = T,angle_col = 0,color = colorpanel(101,"white","firebrick"),annotation_row = tissuemeta,annotation_col = tissuemeta,annotation_colors = ann_cols,show_rownames = F,show_colnames = F,fontsize = 15,number_color = "black",number_format = "%d",breaks = seq(0,30,length.out = 101),annotation_names_col = F,annotation_names_row = F,annotation_legend = F)
dev.off()
